...
const features = [
  { icon: Layout, title: "Prospect Overview", desc: "On chat open, the panel pulls stage, score & history straight from DM Setter OS" },
  { icon: MessageSquare, title: "AI Insights", desc: "Conversation score, booking probability, objections & next action — all computed in the cloud" },
  { icon: Puzzle, title: "AI Replies", desc: "3–5 copy-ready or insert-into-composer suggestions, regenerate on demand — never sent automatically" },
  { icon: Bell, title: "CRM Sync", desc: "Save prospects, update stage & sync conversations into your DM Setter OS pipeline" },
];
...
const steps = [
  ...
  "Click the extension icon and sign in with Google — the same account you use here",
    ...
    <div className="flex-1 p-4 md:p-8 max-w-4xl mx-auto space-y-8">
      ...
      <Card className="bg-card border-primary/20">
        <CardContent className="p-6 flex flex-col items-center gap-4">
          ...
          <p className="text-xs text-muted-foreground">v6.0.0 · Syncs to your account · No API keys needed</p>
