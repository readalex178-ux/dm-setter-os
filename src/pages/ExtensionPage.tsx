...
const features = [
  { icon: MessageSquare, title: "Analyse Conversations", desc: "One click sends the open DM to DM Setter OS for scoring, stage detection & objection spotting" },
  { icon: Puzzle, title: "AI Reply Suggestions", desc: "Get tailored, copy-ready responses generated by your platform — never sent automatically" },
  { icon: Layout, title: "Save to CRM", desc: "Sync prospects, conversations & analysis straight into your DM Setter OS pipeline" },
  { icon: Bell, title: "Lightweight Bridge", desc: "All AI runs in the cloud — the extension just connects Instagram, TikTok, X, Facebook & LinkedIn" },
];
